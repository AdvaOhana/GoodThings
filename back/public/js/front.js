...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const line = document.querySelector('.line-hamburger')

    hamburger.onclick = () => {
        const handleOutSideClick = (e) => {
            console.log(e.target, e.target.classList.contains("line-hamburger"), e.target.classList);

            if (e.target !== hamburgerNav && e.target !== hamburger && !e.target.classList.contains("line-hamburger")) {
                hamburgerNav.classList.toggle("active-hamburger")
